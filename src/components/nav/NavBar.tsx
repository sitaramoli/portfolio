...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className={`${styles.paddingX} w-full flex items-center py-5fixed top-0 z-20 bg-primary`}>
            <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
                ...
                <div className="sm:hidden flex flex-1 justify-end items-center">
                    ...
                    />
                    <div
                        className={`${!toggle ? "hidden" : "flex"} pt-20 p-6 black-gradient absolute top-2 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
