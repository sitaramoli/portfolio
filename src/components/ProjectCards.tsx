...
const ProjectCard: React.FC<ProjectCardProps> = ({index, name, description, image, source_code_link, demo_link}) => {
    return (
        <motion.div variants={fadeIn('up', 'spring', index * 0.5, 0.75)}>
            <Tilt options={{max: 40, scale: 1, speed: 450}}
                ...
                <div className="mt-3 flex justify-center items-center">
                    <a className="shadow-md shadow-primary m-3 p-2 bg-tertiary w-[60%] rounded-lg flex justify-center"
